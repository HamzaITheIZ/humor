                    ...
                    <!--                    <div class="owl-carousel nonloop-block-13">
                                            <div>
                                                <div class="block-testimony-1 text-center">
                                                    ...
                                                    <figure>
                                                        <img src="ussefpic/unknown.png" alt="Image" class="img-fluid rounded-circle mx-auto">
                                                    </figure>
                                                    <h3 class="font-size-20 text-black">unknown friend</h3>
                                                </div>
                                            </div>
                                        </div>-->
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div>
                                <div class="block-testimony-1 text-center">
                                    ...
                                    <h3 class="font-size-20 text-black">unknown friend 1</h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3">
                        ...
                        <div class="col-lg-6">
                            <div>
                                <div class="block-testimony-1 text-center">
                                    ...
                                    <h3 class="font-size-20 text-black">unknown friend 2</h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3">
                        ...
                        <div class="col-lg-6">
                            <div>
                                <div class="block-testimony-1 text-center">
                                    ...
                                    <h3 class="font-size-20 text-black">unknown friend 3</h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3">
